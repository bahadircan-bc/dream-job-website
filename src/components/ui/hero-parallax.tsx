...
export const HeroParallax = ({
  ...
  const translateX = useSpring(
    useTransform(scrollYProgress, [0.2, 1], [0, -200]),
    springConfig
  );
...
export const Header = () => {
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full  left-0 top-0">
      <h1 className="text-2xl md:text-7xl font-bold dark:text-white font-poiret-one">
        Make your <br /> <span className="text-red-500">dreams</span> <br />{" "}
        come true
      </h1>
